...
// TODO adopt to react function and return ReactDOM element
// ------------------------------ Time Frame
...
`
   ...
   function create(angle, amount_of_delimeters, startX, startY, hypotenuse) {
      ...
      clockFrame.innerHTML = scaleContainer

      this.addFrame(clockFrame)


      let clockScale = document.querySelector('div')
      ...
      // probably upper append is unnecessery
      parent_frame.append(clockFrame)
   }

   // make custom props for delimeters
   create(2, 180, 0, -165, 165)
...
export class Stopwatch_Frame extends FrameFactory {
  ...
  setup() {
    ...
    stopwatchFrame.className = 'clock-frame'
     stopwatchFrame.innerHTML = scaleContainer
  }
}
